        ...
        <div className="max-h-80 overflow-y-auto border rounded-md bg-slate-50 p-2 space-y-2 text-xs text-slate-700">
          {loading ? (
            ...
            <p className="text-xs text-slate-500">
              No location notes yet. Ask admin or staff to record teacher locations.
            </p>
          ) : (
            filtered.map((item) => (
              <div
                  ...
                  <div>
                    ...
                    {item.location && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1 text-[10px] text-sky-600 hover:text-sky-800"
                      >
                        Open in Maps
                      </a>
                    )}
